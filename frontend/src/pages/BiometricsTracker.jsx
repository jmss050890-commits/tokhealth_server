          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-gray-500">Normal: Less than 120 mmHg</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-gray-500">Normal: Less than 80 mmHg</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-gray-500">Normal: 36.1-37.2 degrees C</p>
              </div>
